      ...
      ;(r.prototype.init = function(e) {
        ...
        (r.prototype._init = function() {
          ...
          try {
            ...
            var z =
              '-MdYXbMMI' === C.slice(-9)
                ? 'https://us.avoscloud.com'
                : 'https://avoscloud.com'
            C !== AV._config.applicationId &&
              L !== AV._config.applicationKey &&
              AV.init({
                appId: C,
                appKey: L,
                serverURLs: z
            ...
            if (!(R = R instanceof HTMLElement ? R : j[j.length - 1] || null))
              return
            ;(e.el = R),
            ...
            var B = (0 == e.config.meta.length ? b : e.config.meta).map(
              function(t) {
            ...
            e.nodata = {
              show: function(t) {
                return (
                  (P.innerHTML = t || e.locale.tips.sofa),
            ...
            e.loading = {
              show: function(t) {
                ...
                return (
                  t ? U.insertBefore(I, n[0]) : U.appendChild(I),
                  e.nodata.hide(),
                  e
                )
              },
        ...
        (r.prototype.bind = function(e) {
          ...
          var B = function() {
            ...
            N = function() {
              ...
              var e = AV.Object.extend(t.config.clazzName || 'Comment'),
                n = new e(),
                r =
                  '*' === y ? location.pathname.replace(/index\.html?$/, '') : y
              if (
          ...
          u.on('click', P, I),
            u.on('keydown', document, function(e) {
              ...
              ;((e.ctrlKey || e.metaKey) && 13 === t && I(), 9 === t) &&
