      ...
      ;(r.prototype.init = function(e) {
        ...
        (r.prototype._init = function() {
          ...
          try {
            ...
            if (!C || !L) throw 99
            ;(AV.applicationId && delete AV._config.applicationId) ||
              (AV.applicationId = void 0),
            ...
            e.loading = {
              show: function(t) {
                ...
                return (
                  t ? U.insertBefore(P, n[0]) : U.appendChild(P),
                  e.nodata.hide(),
                  e
                )
              },
          ...
          var B = function() {
            ...
            N = function() {
              ...
              var e = AV.Object.extend('Comment'),
                n = new e()
              if (
                ((v.url = decodeURI(y)), (v.insertedAt = new Date()), R.rid)
              ) {
                var r = R.pid || R.rid
                n.set('rid', R.rid),
                  n.set('pid', r),
